...
import { ALLERGY_OPTIONS } from "@/lib/shared";
...
export default function DashboardPage() {
  ...
  const displayPoints = currentPoints ?? user?.points ?? 0;
  ...
  const greetingLabel = user
    ? `${user.grade}학년 ${user.classNum}반`
    : "";
  const schoolLabel = user?.schoolName ?? "";
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>{schoolLabel} · {todayKr}</Text>
          </View>
        </View>
        <View style={styles.headerRight}>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
              <LogOut size={16} color="#86868B" />
              <Text style={{ fontSize: 13, color: "#86868B" }}>로그아웃</Text>
            </View>
          </Button>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Card style={styles.card} testID="card-meals">
          <CardHeader style={styles.cardHeader}>
            <View style={styles.cardTitleRow}>
              ...
              <View>
                <Text style={styles.cardTitle}>오늘 뭐 먹지? 🍱</Text>
              ...
              <>
                {mealData.mealImageUrl ? (
                  <View style={styles.mealImageContainer} testID="img-meal-preview-container">
                    <Image
                      source={{ uri: mealData.mealImageUrl.startsWith("http") ? mealData.mealImageUrl : `${getApiUrl()}${mealData.mealImageUrl}` }}
          ...
          <CardHeader style={styles.cardHeader}>
            <View style={styles.cardTitleRow}>
              ...
              <View>
                ...
                <Text style={styles.cardSubtitle}>참여할수록 쌓여요!</Text>
              </View>
            </View>
          ...
          <CardContent style={styles.cardContent}>
            <View style={styles.grid2}>
              ...
              >
                ...
                <Text style={styles.itemTitle}>평가하기</Text>
            ...
            >
              ...
              <Text style={styles.actionButtonText}>클린플레이트 도전 🥗</Text>
        ...
        <View style={styles.grid2}>
          ...
          >
            ...
            <Text style={styles.itemTitle}>버디 찾기</Text>
