...
export default function CleanPlateScreen() {
  ...
  const uploadMutation = useMutation({
    mutationFn: async (uri: string) => {
      ...
      const res = await apiRequest("POST", "/api/cleanplate/upload", formData);
                ...
                {uploadResult && (
                  ...
                  >
                    ...
                    uploadResult.verdict === "APPROVE" ? (
                      ...
                      <View>
                        <Text style={styles.resultTextUntouched}>반환 처리됐습니다.</Text>
                        <Text style={styles.resultTextUntouchedSub}>
                          음식을 먹은 뒤 사진을 다시 찍어 올려주세요!
                        </Text>
                      </View>
                    ) : uploadResult.status === "REJECTED" ? (
                    ...
                    >
                      {uploadMutation.isPending ? (
                        <>
                          ...
                          <Text style={styles.uploadAreaTitle}>업로드 중...</Text>
                        </>
                      ) : (
                        <>
