...
import { CATEGORY_COLORS, STATUS_CONFIG } from "@gipsige/shared";
import type { StoreItem, RedemptionWithItem } from "@gipsige/shared";
      ...
      <Tabs defaultValue="items" style={{ flex: 1 }}>
        ...
        <TabsContent value="items" style={{ flex: 1 }}>
          {itemsLoading ? (
            ...
            <EmptyState
              icon={<ShoppingBag size={24} color="#86868B" />}
        ...
        <TabsContent value="history" style={{ flex: 1 }}>
          {redemptionsLoading ? (
            ...
            <EmptyState
              icon={<ClipboardList size={24} color="#86868B" />}
              title="교환 내역이 없어요"
